...
<body>
	<div class="zc">
        <form name="ZC" action="/WEB-INF/Tijiao.jsp" method="post" onSubmit="return check(this)">
            <table>
                <tr><td>用户名:</td> <td><input type="text" name="yonghu" value=""/></td></tr>
                <tr><td>密码:</td> <td><input type="password" name="mima1" value=""/></td></tr>
                <tr><td>确认密码:</td> <td><input type="password" name="mima2" value=""></td></tr>
                <tr><td>电话号码:</td> <td><input type="text" name="dianhua" value=""></td></tr>
				...
				<tr><td>爱好：</td><td>
					<input type="checkbox" name="del[]" value="打篮球">打篮球
					<input type="checkbox" name="del[]" value="看电影">看电影
					<input type="checkbox" name="del[]" value="玩游戏">玩游戏
				</td></tr>
